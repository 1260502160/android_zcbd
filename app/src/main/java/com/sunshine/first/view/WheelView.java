package com.sunshine.first.view;
...
public class WheelView extends View {
    ...
    private WheelDialog.OnItemSelectedListener onItemSelectedListener;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.sp_19);//默认大小
...
//        isLoop = true;
    ...
    public final void setOnItemSelectedListener(WheelDialog.OnItemSelectedListener OnItemSelectedListener) {
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
    ...
    public static interface IPickerViewData {
