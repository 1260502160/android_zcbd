...
public class BackMoneyAdapter extends RecyclerView.Adapter<BackMoneyAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public BackMoneyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new BackMoneyAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.adapter_all_indent,viewGroup,false));
    }

    @Override
    public void onBindViewHolder(@NonNull BackMoneyAdapter.ViewHolder viewHolder, int i) {
