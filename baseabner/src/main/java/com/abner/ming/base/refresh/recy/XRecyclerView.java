...
public class XRecyclerView extends RecyclerView {
    ...
    private OnScrollSatte mOnScrollSattes;
    public void setOnScrollSatte(OnScrollSatte mOnScrollSattes){
        this.mOnScrollSattes=mOnScrollSattes;
    }
    public interface OnScrollSatte{
    ...
    private void init() {
        if (pullRefreshEnabled) {
            ...
            mRefreshHeader.setOnScrollSatte(new ArrowRefreshHeader.OnScrollSatte() {
                @Override
                public void state(int state) {
                        if(mOnScrollSattes!=null){
                            mOnScrollSattes.state(state);
                        }
                }
            });
        }
